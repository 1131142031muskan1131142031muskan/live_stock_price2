...
api_url = f'https://flask-api-2-mgs8.onrender.com/get_stock_price?ticker={ticker}&exchange={exchange}'
...
try:
    ...
    if response.status_code == 200:
        ...
        if "price" in data:
            ...
            st.write(f"The stock price of {ticker} on {exchange} is: ₹{data['price']}")
        else:
